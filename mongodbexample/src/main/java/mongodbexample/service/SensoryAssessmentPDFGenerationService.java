...
@Service
public class SensoryAssessmentPDFGenerationService {
    
    @Autowired
    private SensoryAssessmentResultRepository assessmentRepository;
    ...
    public byte[] generateAssessmentReport(String childId, String childName) throws Exception {
        SensoryAssessmentResult assessment = assessmentRepository.findByChildId(childId)
            .stream()
            .findFirst()
            .orElseThrow(() -> new RuntimeException("Assessment not found"));

        List<SensoryScreeningAssessment> screeningQuestions = 
            screeningRepository.findByAssesstypeid("ASSESSTYPE_9");
        ...
        contentStream.showText("Sensory Screening Checklist Report");
